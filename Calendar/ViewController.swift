...
//  Calendar
//
//  Created by Alexis Hernandez on 8/1/17.
...
extension ViewController: JTAppleCalendarViewDelegate {
    ...
    //Display the cell
    func calendar(_ calendar:  JTAppleCalendarView, cellForItemAt data: Date, cellState: CellState, indexPath: IndexPath) -> JTAppleCell {
